...
public abstract class AbstractTinyMCEConfiguration {
    protected abstract void onTinyMCEInitialized();
    ...
    private String[] plugins = new String[] {"layer","table","save","paste","preview"};

    private String[] themeAdvancedButtons1 = new String[] {"bold", "italic", "underline", "strikethrough", "|", "justifyleft", "justifycenter", "justifyright", "justifyfull", "formatselect"};
    ...
    private String[] themeAdvancedButtons3 = new String[] {"preview", "hr", "removeformat", "visualaid", "|", "sub", "sup", "|", "charmap", "iespell", "advhr", "|", "ltr", "rtl", "|", "fullscreen"};
